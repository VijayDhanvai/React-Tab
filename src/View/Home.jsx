    ...
    return (
        ...
        <div className="sm:container mx-auto px-4">
            ...
            <h1 className="text-slate-800 font-title text-3xl font-semibold p-2 text-center uppercase">
                React with <span className="text-blue-600">Tailwind</span> from the very basic step by step.
            </h1>
            <p className="text-stone-700 text-center">
                Example here are demonstrates some of the core
                features of React from the very basic.
            </p>
            </div>
